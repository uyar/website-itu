...
BLOG_AUTHOR = "H. Turgut Uyar"  # (translatable)
BLOG_TITLE = "H. Turgut Uyar"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://web.itu.edu.tr/uyar/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "uyar@itu.edu.tr"
BLOG_DESCRIPTION = {
    "tr": "H. Turgut Uyar'ın İstanbul Teknik Üniversitesi ile ilgili sayfası.",
    "en": "Personal page of H. Turgut Uyar relating to Istanbul Technical University.",
}
...
# (translatable)
CONTENT_FOOTER = {
    "tr": '<small>İçerik &copy; {date}         <a href="mailto:{email}">{author}</a> - <a href="https://getnikola.com" rel="nofollow">Nikola</a>         ile üretilmiştir         {license}</small>',
    "en": '<small>Contents &copy; {date}         <a href="mailto:{email}">{author}</a> - Powered by         <a href="https://getnikola.com" rel="nofollow">Nikola</a>         {license}</small>',
}
